...
Shader "Particles/Additive Intensify" {
	Properties{
		...
		[Toggle] _SoftParticles("Soft particles",Range(0,1)) = 0
		_InvFade("Soft Particles Factor", Range(0.01,3.0)) = 1.0
		_Glow("Intensity", float) = 1
	}
		...
		Category{
			...
			SubShader {
				Pass {
					...
					#pragma shader_feature __ _SOFTPARTICLES_ON
					...
					v2f vert(appdata_t v)
					{
						...
						o.color.rgb *= UNITY_ACCESS_INSTANCED_PROP(Props, _Glow);
